...
const skills = ["html", "css", "sass", "tailwind", "javascript", "typescript", "react", "redux", "nodejs", "express", "nestjs", "nextjs", "php", "wordpress", "laravel", "python", "flask", "django", "java", "mongodb", "postgresql", "mysql", "git", "linux", "windows", "nix", "bash", "powershell", "go", "docker", "kubernetes", "prometheus", "grafana"];
